...
public class Sku extends BaseEntity<Long> {
	 ...
	 */
	@Transient
	public com.igomall.entity.Store getStore() {
	 ...
	 */
	@Transient
	public BigDecimal getCommission(com.igomall.entity.Store.Type type) {
		...
		if (type != null && getProduct() != null && getProduct().getProductCategory() != null) {
			...
			if (com.igomall.entity.Store.Type.general.equals(type) && productCategory.getGeneralRate() > 0) {
				commission = getPrice().multiply(new BigDecimal(productCategory.getGeneralRate().toString()));
			} else if (com.igomall.entity.Store.Type.self.equals(type) && productCategory.getSelfRate() > 0) {

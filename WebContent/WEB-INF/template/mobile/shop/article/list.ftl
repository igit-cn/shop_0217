...
<head>
	...
	[@seo type = "articleList"]
		...
		[/#if]
		<title>[#if articleCategory.resolveSeoTitle()?has_content]${articleCategory.resolveSeoTitle()}[#else]${seo.resolveTitle()}[/#if][#if showPowered] - Powered By IGOMALL[/#if]</title>
	[/@seo]

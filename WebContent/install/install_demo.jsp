...
<%@page import="com.igomall.util.FreeMarkerUtils"%>
<%@page import="com.igomall.util.JsonUtils"%>
...
<%
	...
	if (!failed) {
		if ("mysql".equals(databaseType)) {
			...
			sqlFile = new File(application.getRealPath("/install/data/mysql/demo.sql"));
		} else if ("sqlserver".equals(databaseType)) {
			jdbcUrl = "jdbc:sqlserver://" + databaseHost + ":" + databasePort + ";DatabaseName=" + databaseName;
			sqlFile = new File(application.getRealPath("/install/data/sqlserver/demo.sql"));
		} else if ("oracle".equals(databaseType)) {
			jdbcUrl = "jdbc:oracle:thin:@" + databaseHost + ":" + databasePort + ":" + databaseName;
			sqlFile = new File(application.getRealPath("/install/data/oracle/demo.sql"));
		} else {
			failed = true;
			message = "参数错误!";
		}
